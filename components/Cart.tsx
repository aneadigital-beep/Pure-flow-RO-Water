  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center px-4">
        ...
        <p className="text-gray-500 text-sm">Looks like you haven't added any water cans or plans yet.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 pb-10">
              ...
              <div className="flex items-center justify-between mt-2">
                <div className="flex items-center gap-3 bg-gray-50 rounded-lg px-2 py-1">
                  <button 
                    ...
                    className="h-6 w-6 rounded-md bg-white border border-gray-200 flex items-center justify-center text-gray-600 active:bg-gray-100"
                  >
      ...
      <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 space-y-6">
        ...
        {paymentMethod === 'UPI/Online' && (
          <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100 animate-in zoom-in-95 duration-300">
            <div className="text-center space-y-4">
              <h4 className="text-xs font-bold text-blue-800 uppercase tracking-widest">Scan & Pay Now</h4>
              ...
              <div className="space-y-1">
                <p className="text-[10px] text-blue-600 font-bold">UPI ID: {DEFAULT_UPI_ID}</p>
                <p className="text-[10px] text-gray-400 italic">Please share a screenshot of the payment on WhatsApp after ordering.</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="flex justify-between font-black text-xl text-gray-800 pt-3 border-t border-gray-100">
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white py-5 rounded-2xl font-bold shadow-xl transition-all active:scale-95 flex items-center justify-center gap-3"
        >
