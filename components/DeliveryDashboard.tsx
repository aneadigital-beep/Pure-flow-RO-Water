          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              <p className="text-green-100 text-[10px] font-bold uppercase tracking-wider">
                Partner ID: {user.mobile || (user as any).id}
              </p>
              <p className="text-white bg-white/20 px-2 py-0.5 rounded text-[10px] font-medium">
                {activeOrders.length} Tasks Assigned
              </p>
            </div>
          </div>
          <div className="h-12 w-12 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-md shrink-0">
          ...
          activeOrders.length > 0 ? (
            ...
            <div className="py-20 text-center animate-in fade-in">
              <div className="h-20 w-20 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto mb-4">
                <i className="fas fa-clipboard-check text-slate-300 dark:text-slate-600 text-3xl"></i>
              </div>
              <h3 className="text-slate-800 dark:text-slate-100 font-bold">No Active Tasks</h3>
              <p className="text-slate-400 text-xs mt-1">Pending orders assigned by admin will appear here.</p>
            </div>
          )
        ) : (
