  ...
  return (
    <div className="flex flex-col h-[calc(100vh-160px)] animate-in fade-in duration-300">
      <div className="flex items-center gap-4 mb-4">
        ...
        <h2 className="text-xl font-bold text-gray-800">Water Assistant</h2>
      </div>

      <div className="flex flex-col flex-1 bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden">
        <div className="bg-blue-600 p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-200 text-[10px]">Always active for your health</p>
          </div>
        </div>
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50">
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-white border border-gray-100 rounded-2xl rounded-tl-none px-4 py-2 flex gap-1">
        ...
        <form onSubmit={handleSubmit} className="p-4 bg-white border-t border-gray-100 flex gap-2">
          ...
          <button 
            ...
            className="h-10 w-10 rounded-xl bg-blue-600 text-white flex items-center justify-center disabled:opacity-50 transition-transform active:scale-95 shadow-md"
          >
